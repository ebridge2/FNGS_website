...
class SubmissionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        help_texts={
            ...
            'datasetname':_('Name of your dataset (only required for group analysis)'),
            'modality':_('Modality of the data. Functional or Diffusion.'),
            'slice_timing':_('The method in which the data slices were acquired. Only needed for fMRI.'),
            'data_file':_('Local data that you want to upload to the specified S3 bucket before running analysis (zipped at one level above BIDS root)'),
