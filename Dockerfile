...
RUN pip install --ignore-installed cython numpy coveralls wget nibabel nilearn dipy sklearn networkx boto3 multiprocessing awscli plotly
...
# Get atlases
RUN cd /FNGS_server && wget http://openconnecto.me/mrdata/share/demo_data/demo_atlases.zip && unzip demo_atlases.zip && mv demo_atlases atlases
